                    ...
                    error || errorShip ? <ErrorMsg message={error || errorShip} /> :
                        orders.length !== 0 ? (
                            <table className='orders-list-table'>
                                <thead>
                                    <tr>
                                        <th scope='col' width='11.5%'>ORDER ID</th>
                                        <th scope='col' width='11.5%'>DATE</th>
                                        <th scope='col' width='11.5%'>USER</th>
                                        <th scope='col' width='16.25%'>SHIPPING INFO</th>
                                        <th scope='col' width='16.25%'>ITEMS</th>
                                        <th scope='col' width='11.5%'>PAID</th>
                                        <th scope='col' width='11.5%'>SHIPPED</th>
